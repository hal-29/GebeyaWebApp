...
function Sidebar({ isOpen, setIsOpen }) {
  ...
  return (
    <aside
      ref={sidebarEl}
      className={`top-12 fixed z-20  flex flex-col gap-2 bg-white shadow-md p-4 w-80 h-[calc(100svh_-3rem)] transition-all sidebar ${isOpen ? "right-0" : "-right-full"
        }`}
    >
      ...
      <div className="flex flex-col gap-4 py-3">
        <button
          ...
          className={` p-3 text-gray-50 ${cartItems.length && user
              ? "bg-red-800/90"
